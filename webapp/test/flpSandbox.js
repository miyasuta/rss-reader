		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rss Reader",
									"targetURL": "#miyasutarssreader-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"miyasutarssreader-display": {
								"semanticObject": "miyasutarssreader",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=miyasuta.rssreader",
									"url": sap.ui.require.toUrl("miyasuta/rssreader")
								}
							}
						}
					}
